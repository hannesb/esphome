...
void PulseMeterSensor::set_total_pulses(int32_t pulses) {
  ESP_LOGD(TAG, "'%s': set_total_pulses %ld", this->get_name().c_str(), pulses);
...
void PulseMeterSensor::set_total_pulses_up(uint32_t pulses) {
  ESP_LOGD(TAG, "'%s': set_total_pulses_up %lu", this->get_name().c_str(), pulses);
...
void PulseMeterSensor::set_total_pulses_down(uint32_t pulses) {
  ESP_LOGD(TAG, "'%s': set_total_pulses_down %lu", this->get_name().c_str(), pulses);
